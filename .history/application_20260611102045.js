...
function actualizarNavbar() {
    ...
    if (user) {
        ...
        if (usernameDisplay) {
            // Imagen de fallback por si el usuario no tiene avatar definido o está en blanco
            ...
            // Inyectamos el componente visual de imagen con microinteracciones y tooltip nativo
